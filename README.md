...
> Companion to [`Bommelcode/livefire`](https://github.com/Bommelcode/livefire) (the Python application). This repo holds only the Companion-side TypeScript module.
...
This module is purely a UI for the OSC API liveFire exposes. The server-side spec lives in liveFire's repo:

- Feedback push: [`livefire/engines/osc_feedback.py`](https://github.com/Bommelcode/livefire/blob/main/livefire/engines/osc_feedback.py)
- Command router: [`livefire/playback/controller.py`](https://github.com/Bommelcode/livefire/blob/main/livefire/playback/controller.py) — search `_handle_livefire_command`
